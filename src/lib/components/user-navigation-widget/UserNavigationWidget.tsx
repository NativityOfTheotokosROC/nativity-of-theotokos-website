					...
					<Disclosure>
						{({ open }) => (
							<>
								...
								<DisclosurePanel
									transition
									className="flex origin-top flex-col border-t border-white/12 bg-gray-800 py-2 duration-300 ease-out *:w-full *:px-6 *:py-4 *:text-left *:uppercase *:hover:text-[#ffdc4f] *:active:bg-gray-950 *:active:text-[#ffdc4f] data-closed:h-1/2 data-closed:-translate-y-4 data-closed:opacity-0 md:*:px-8"
								>
									{[
