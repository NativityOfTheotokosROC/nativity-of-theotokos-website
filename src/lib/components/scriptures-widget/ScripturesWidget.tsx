...
const ScripturesWidget = function ({ model }) {
	...
	return (
		...
		>
			...
			<div className="flex max-h-[15em] min-h-[9em] bg-gray-700 p-6 text-white md:max-h-[11em] md:px-10 lg:px-6 [&_a]:underline [&_a]:hover:text-[#ffdc4f] [&_a]:hover:underline">
