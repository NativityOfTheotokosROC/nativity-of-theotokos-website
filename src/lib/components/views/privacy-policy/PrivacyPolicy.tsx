			...
			<div className="flex flex-col gap-6 [&_a]:underline [&_a]:hover:text-[#dcb042] [&_a]:active:text-[#dcb042]">
				<section className="flex flex-col gap-3">
					<p>
						...
						include the above mentioned website.
					</p>
				</section>
				<section className="flex flex-col gap-3">
					...
					<p>
						...
						when you sign into our website through the third-party
						authentication providers we expose: examples including
						Google OAuth 2.0 and Microsoft OAuth 2.0. We collect
						your email address and possibly your name when you
					...
					<p>
						...
						may understand how those websites collect, use and share
				...
				<section className="flex flex-col gap-3">
					...
					<p>
						...
						services; and to deliver services specifically requested
						by you. Nativity of the Theotokos Russian Orthodox
						Church may also use your personally identifiable
						information to inform you of other products or services
						available from the church. Our email marketing is
						permission-based and we will only send you information
						relevant to what you opted-in or signed up for. You may
						choose to cancel your email subscription at any time.
						Nativity of the Theotokos Russian Orthodox Church does
						not sell, rent or lease its customer lists to third
						parties. Nativity of the Theotokos Russian Orthodox
						Church may share data with trusted partners to help
						perform statistical analysis, to send you email, and to
						provide customer support. All such third parties are
						prohibited from using your personal information except
						to provide these services to Nativity of the Theotokos
						Russian Orthodox Church, and they are required to
				...
				<section className="flex flex-col gap-3">
					...
					<p>
						...
						OAuth 2.0 and Microsoft OAuth 2.0, to secure and
						streamline the login process. When you log in using
						OAuth 2.0, a cookie is generated and stored on your
						device. This cookie is essential for the proper
						functioning of our authentication system.
					</p>
					<p>
						The cookie contains a unique identifier that helps us
						recognize your authenticated session. It enables you to
						access our application seamlessly without the need to
						re-enter your credentials repeatedly during a single
						session.
					</p>
					<p>
						It is important to note that these cookies DO NOT store
						your actual login credentials on our servers or on your
						browser. Instead, they serve as tokens that establish a
						secure connection between your browser and the
						authentication provider. This enhances the security of
						the authentication process while providing a more
				...
				<section className="flex flex-col gap-3">
					...
					<p>
						...
						opt-out of receiving email updates and to delete your
						data. Users may opt-out of receiving any or all
						communications from Nativity of the Theotokos Russian
						Orthodox Church, and request personal data deletion by
						contacting us via{" "}
				...
				<section className="flex flex-col gap-3">
					...
					<p>
						...
						church and user feedback. This will be reflected by a{" "}
						{'"Last Updated"'} date at the top of the page. We
