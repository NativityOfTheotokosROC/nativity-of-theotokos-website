import { GallerySectionModel } from "@/src/lib/models/gallery-section";
		...
		<section id="media" className="gallery text-black">
			{modelView && (
				<div className="gallery-content flex flex-col gap-8 p-8 px-4 py-14 lg:px-10">
					<div className="swiper-container h-[23em] max-h-[23em] w-full max-w-full md:h-[20em] lg:h-[23em]">
						<Swiper
								...
								...modelView.galleryImages.map(
									(galleryImage, index) => (
										<SwiperSlide key={index}>
											<div className="flex h-full w-full items-stretch justify-stretch overflow-clip rounded-lg">
												<Image
