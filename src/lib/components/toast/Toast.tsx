...
const Toast = function ({ model }) {
	...
	return (
		<div
			className={`toast flex max-w-full items-center justify-center overflow-clip rounded-lg border border-gray-400 bg-gray-800/99 p-6 text-center text-white md:max-w-md`}
		>
